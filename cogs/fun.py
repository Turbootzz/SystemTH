...
#        await ctx.send(random.choice(kies))
    ...
    async def applejuice_embed(self, ctx):
        applejuice_image=[
            ...
            ('http://turboot.com/applejuice/3.jpg', 'WOW DONT TOUCH THAT B**'),
            ('http://turboot.com/applejuice/4.jpg', 'HEY dont mind me AND MY APPLE JUICE LOL'),
            ...
            ('http://turboot.com/applejuice/8.jpg', 'Those tintels I LIKE'),
            ('http://turboot.com/applejuice/9.jpg', 'My tongue is twerking..'),
            ('http://turboot.com/applejuice/10.jpg', 'SLURP'),
            ('http://turboot.com/applejuice/11.jpg', 'HAHA YOU SAW THAT?? NO IT WAS MY APPLEJUICE DUDE'),
            ('http://turboot.com/applejuice/12.jpg', 'HAHA'),
            ('http://turboot.com/applejuice/13.jpg', 'OOPS- I think i licked the fart'),
            ('http://turboot.com/applejuice/14.jpg', 'OMG NO WAY ITS IT'),
            ('http://turboot.com/applejuice/15.jpg', 'BETTER THAN WAIFUS'),
            ('http://turboot.com/applejuice/16.jpg', 'PLEASE TOUCH ME'),
            ('http://turboot.com/applejuice/17.jpg', 'DONT TOUCH ME DUDE TF'),
            ('http://turboot.com/applejuice/18.jpg', 'EY that mine.'),
            ('http://turboot.com/applejuice/19.jpg', 'BITCH ITS SHINING'),
            ('http://turboot.com/applejuice/20.jpg', '**Moans**')
        ]
        embed = discord.Embed(
            color=discord.Colour.dark_blue()
...
# * daarmee kan je spaties gebruiken na het command
    ...
    async def playsound(self, ctx, *args):
        ...
        #voice_client = client.voice_client_in(server)
            ...
            if args[0] == "yum":
                print(f"Playing yum by: {ctx.author}.")
                retStr = str("""```css\nPlaying sound: YUM```""")
                await ctx.send(retStr)
                source = discord.FFmpegPCMAudio("sounds/yum.mp3")
            ...
            if args[0] == "scawy":
                print(f"Playing scawy by: {ctx.author}.")
                retStr = str("""```css\nPlaying sound: scawy```""")
                await ctx.send(retStr)
                source = discord.FFmpegPCMAudio("sounds/scawy.mp3")
            ...
            if args[0] == "jeen":
                print(f"Playing jeen by: {ctx.author}.")
                retStr = str("""```css\nPlaying sound: Jeen```""")
                await ctx.send(retStr)
                source = discord.FFmpegPCMAudio("sounds/jeen.mp3")
                await asyncio.sleep(0.2)
                voice_player.play(source)
            ...
            if args[0] == "pee":
                print(f"Playing pee by: {ctx.author}.")
                retStr = str("""```css\nPlaying sound: pee```""")
                await ctx.send(retStr)
                source = discord.FFmpegPCMAudio("sounds/pee.mp3")
                await asyncio.sleep(0.2)
                voice_player.play(source)
            ...
            if args[0] == "senpai":
                print(f"Playing Senpai by: {ctx.author}.")
                retStr = str("""```css\nPlaying sound: senpai (not listed)```""")
                await ctx.send(retStr)
                source = discord.FFmpegPCMAudio("sounds/senpai.mp3")
                await asyncio.sleep(0.2)
                voice_player.play(source)
                await asyncio.sleep(1.5)
                await voice_player.disconnect()
            ...
            if args[0] == "hayyah":
                print(f"Playing HAYYAH by: {ctx.author}.")
                retStr = str("""```css\nPlaying sound: HAYYAH```""")
                await ctx.send(retStr)
                source = discord.FFmpegPCMAudio("sounds/hayyah.mp3")
                await asyncio.sleep(0.2)
                voice_player.play(source)
                await asyncio.sleep(2.3)
                await voice_player.disconnect()
            ...
            if args[0] == "hayyah2":
                print(f"Playing HAYYAH by: {ctx.author}.")
                retStr = str("""```css\nPlaying sound: HAYYAH2 (not listed)```""")
                await ctx.send(retStr)
                source = discord.FFmpegPCMAudio("sounds/hayyah2.mp3")
                await asyncio.sleep(0.2)
                voice_player.play(source)
